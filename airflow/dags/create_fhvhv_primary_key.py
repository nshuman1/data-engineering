...
#
    ...
    df['primary_key'] = df['dropoff_datetime'].map(str) + df['pickup_datetime'].map(str) + df['PULocationID'].map(str) + df['DOLocationID'].map(str) + df['base_passenger_fare'].map(str) + df['driver_pay'].map(str)
